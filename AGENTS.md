...
Guidance for coding agents working on Socca2 (replaces CLAUDE.md). Keep it current; prefer this over legacy docs when instructions conflict.
...
- Playwright E2E suite (79-80 tests) with auto-started test servers.
...
claudedocs/# Deep-dive docs (mechanics, testing, lag)
```
...
- Latest working overview: `README.md`, `QUICKSTART.md`.
- Deep dives: `claudedocs/BALL_CAPTURE_MECHANISM.md`, `claudedocs/SHOOTING_IMPLEMENTATION_RESULTS.md`, `client/src/ai/AI_STRUCTURE.md`.
- Legacy/high-level: `ARCHITECTURE.md`, `SPECIFICATION.md` (contain historical plans; defer to this file for current state).

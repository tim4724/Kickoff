# Socca2 Roadmap (concise)

Current state: 3v3 multiplayer with AI bots, authoritative Colyseus server, client prediction, unified 1920×1080 coordinates, and a passing Playwright suite (79-80 tests).
...
- Mechanics deep dives: `claudedocs/` (historical—verify against `shared/src/types.ts`)

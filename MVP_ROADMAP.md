...
Current state: 3v3 multiplayer with AI bots, authoritative Colyseus server, client prediction, unified 1920×1080 coordinates, and a passing Playwright suite (40 tests).

...
export class VirtualJoystick {
  ...
  private updateStickPosition(x: number, y: number) {
    ...
    const distance = GeometryUtils.distance({ x: this.baseX, y: this.baseY }, { x, y })
  ...
  public getInput(): { x: number; y: number } {
    ...
    const distance = GeometryUtils.distance({ x: this.baseX, y: this.baseY }, { x: this.stick.x, y: this.stick.y })
